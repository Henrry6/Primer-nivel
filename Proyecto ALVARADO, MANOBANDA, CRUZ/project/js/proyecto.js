  ...
  var opcion4=document.getElementById('opcion4');
      ...
      var jugar={
                preguntas:[
                          {x:'Cuál es el entorno que esta conformado por elementos que nacen de forma natural?', 
                          opciones:['A) ambiente','B) medio ambiente natural',
                          'C) ciudades','D) colonias'],respuesta:2},

                          {x:'Qué es lo que más causa el ser humano?',
                         opciones:['A) Destrucción ','B) Recursos naturales','C) Bienestar',
                         'D) Contaminación'],respuesta:4},
                        
                          {x:'Cómo se le conoce al incremento de la temperatura en el planeta?',
                          opciones:['A) ebullición','B) calentamiento global ',
                          'C) cocción','D) efecto invernadero '],respuesta:2},
 
                         {x:'Qué recomienda para el cuidado del medio ambiente?', 
                           opciones:['A) ahorrar agua','B) plantar arboles',
                           'C)evitar botar basura','D) todos los anteriores'],respuesta:4},

                         {x:'La contaminación a quien puede afectar?', 
